  ...
  const values = [
    {
      ...
      title: 'ersonalização',
      description:
        'Soluções digitais que refletem identidade e objetivos reais',
      icon: Target,
    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          >
            A Versiory é uma empresa jovem especializada em solução web,
            nascemos para fortalecer sua autoridade online, atrair mais clientes
            e gerar valor real para suas marcas.
          </p>
        </div>
        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center mb-20'>
          {/* Visão e Missão */}
          <div
            ref={visionMissionAnimation.ref}
            style={visionMissionAnimation.style}
            className='space-y-8'
          >
            <motion.div
            ...
            >
              <h3 className='text-2xl font-bold bg-gradient-to-r from-versiory-green to-versiory-azure bg-clip-text text-transparent mb-4'>
                Nossa Visão
              </h3>
              <p
                className={`leading-relaxed ${theme === 'dark' ? 'text-white/90' : 'text-gray-800'}`}
              >
                Ser reconhecida pela criatividade, excelência em inovação
                digital, inteligência estratégica e pelo compromisso contínuo
                com a evolução sustentável dos negócios de nossos clientes e
                parceiros.
              </p>
            </motion.div>
            ...
            >
              ...
              <p
                className={`leading-relaxed ${theme === 'dark' ? 'text-white/90' : 'text-gray-800'}`}
              >
                Fortalecer a autoridade digital de nossos clientes, atrair
                oportunidades estratégicas e valorizar o posicionamento dos
                negócios por meio de soluções digitais de alto impacto.
              </p>
            </motion.div>
          </div>
        ...
        <div ref={valuesAnimation.ref} style={valuesAnimation.style}>
          <div className='text-center mb-12'>
            ...
            <p
              className={`text-xl ${theme === 'dark' ? 'text-white/80' : 'text-gray-700'}`}
            >
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
            {values.map(value => (
              <div key={`${value.letter}${value.title}`} className='relative'>
                ...
                >
                  <div
                    className={`w-12 h-12 bg-gradient-to-r ${value.color} rounded-lg flex items-center justify-center mb-4 mx-auto`}
                  >
                  ...
                  >
                    <span className='bg-gradient-to-r from-versiory-green to-versiory-azure bg-clip-text text-transparent'>
                      {value.letter}
                    </span>
                    {value.title}
                  </h4>
