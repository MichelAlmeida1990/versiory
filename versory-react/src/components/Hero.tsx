        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              <div className='space-y-3'>
                <div className='flex items-center space-x-3'>
                  ...
                  <span
                    className={`text-lg ${theme === 'dark' ? 'text-white/80' : 'text-gray-700'}`}
                  >
          ...
          >
            ...
            <div className='relative rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-versiory-azure/20 to-versiory-green/20 p-2'>
              <div className='relative aspect-video rounded-xl overflow-hidden'>
                {!videoError ? (
                  ...
                  >
                    <source
                      src='/images/WhatsApp Video 2025-08-23 at 13.55.43.mp4'
                      type='video/mp4'
                    />
                  ...
                  <div className='w-full h-full bg-gradient-to-br from-versiory-azure/20 to-versiory-green/20 flex items-center justify-center'>
                    <div className='text-center'>
                      <Play
                        size={64}
                        className='text-versiory-azure mx-auto mb-4'
                      />
                      <p className='text-versiory-azure font-semibold'>
            ...
            <div className='grid grid-cols-2 gap-4 mt-6'>
              ...
              >
                <div className='text-2xl font-bold text-versiory-azure'>
                  50+
                </div>
                <div
              ...
              >
                <div className='text-2xl font-bold text-versiory-green'>
                  100%
                </div>
                <div
                  className={`text-sm ${theme === 'dark' ? 'text-white/70' : 'text-gray-600'}`}
