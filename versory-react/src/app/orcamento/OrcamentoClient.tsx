...
export default function OrcamentoClient() {
  ...
  const services: Service[] = [
    ...
    },
    {
      ...
      description:
        'Sites profissionais para empresas e profissionais liberais com design moderno.',
      icon: Globe,
      category: 'web',
      features: [
        'Design Responsivo',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10'>
        ...
        >
          <div className='flex items-center space-x-3 mb-4'>
            ...
            <h3 className='text-xl font-bold text-white'>Análise de Mercado</h3>
          </div>
          <p className='text-white/80'>
            Nossos preços são baseados em pesquisas de mercado atual, oferecendo
            soluções de qualidade a preços ultra-competitivos para empresas em
            crescimento. Economize até{' '}
            <span className='font-bold text-versiory-green'>70%</span> em
            relação ao mercado.
            <br />
            <br />
            <span className='font-semibold text-versiory-green'>
              💡 Ideal para startups e pequenas empresas que querem qualidade
            ...
            >
              ...
              <div className='border-t border-versiory-azure/20 pt-4'>
                <div className='flex items-center justify-between mb-2'>
                  ...
                  <span className='text-lg font-bold text-versiory-green'>
                    {formatPrice(service.ourPrice)}
                  </span>
                </div>
                ...
                <div className='mt-2 text-center'>
                  <span className='text-xs bg-versiory-green/20 text-versiory-green px-2 py-1 rounded-full'>
                    Economia de{' '}
                    {calculateSavings(service.marketPrice, service.ourPrice)}%
                  </span>
                </div>
              </div>
          ...
          <div className='text-center mt-8'>
            <div className='bg-gradient-to-r from-versiory-green/20 via-versiory-azure/20 to-versiory-pink/20 backdrop-blur-sm border border-versiory-green/30 rounded-2xl p-6'>
              ...
              <p className='text-lg text-white/90 font-medium mb-3'>
                <span className='font-bold text-versiory-green'>
              ...
              <div className='mt-4 p-3 bg-versiory-green/10 rounded-lg border border-versiory-green/20'>
                <p className='text-sm text-versiory-green font-semibold'>
                  ...
                  <span className='font-bold'>
                    Indique um cliente e ganhe 10% de desconto
                  </span>{' '}
                  no próximo projeto!
                </p>
              </div>
        ...
        >
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            >
              ...
              <p className='text-sm text-white/70 mb-2'>versiory@gmail.com</p>
              <span className='text-xs bg-versiory-pink/20 text-versiory-pink px-3 py-1 rounded-full'>
        ...
        {showDetails && selectedService && (
          ...
          >
            ...
            >
              ...
              <div className='text-center mb-8'>
                <div
                  className={`w-20 h-20 bg-gradient-to-r ${selectedService.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}
                >
                  ...
                  <div className='space-y-3'>
                    {selectedService.features.map((feature, index) => (
                      ...
                      >
                        <Check
                          size={20}
                          className='text-versiory-green flex-shrink-0'
                        />
                        <span>{feature}</span>
                      </div>
                    ))}
                  ...
                  <div className='space-y-4'>
                    <div className='p-4 rounded-lg bg-versiory-blue/10'>
                      <div className='flex items-center justify-between mb-2'>
                        ...
                        <span className='text-2xl font-bold text-versiory-green'>
                          {formatPrice(selectedService.ourPrice)}
                        </span>
                      </div>
                    ...
                    <div className='p-4 rounded-lg bg-versiory-pink/10'>
                      <div className='flex items-center justify-between mb-2'>
                        ...
                        <span className='text-lg line-through text-gray-500'>
                          {formatPrice(selectedService.marketPrice)}
                        </span>
                      </div>
