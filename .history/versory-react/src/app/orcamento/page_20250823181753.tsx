...
const OrcamentoPage = () => {
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gradient-to-b from-versiory-black to-versiory-blue/10' : 'bg-gradient-to-b from-blue-50 to-white'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              ...
              <div className="border-t border-versiory-azure/20 pt-4">
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-xs ${theme === 'dark' ? 'text-white/40' : 'text-gray-400'}`}>Mercado:</span>
        ...
        <motion.div
          ...
          className={`mb-12 p-8 rounded-2xl backdrop-blur-sm border ${theme === 'dark' ? 'bg-gradient-to-r from-versiory-pink/10 to-versiory-azure/10 border-versiory-pink/30' : 'bg-gradient-to-r from-pink-50 to-blue-50 border-pink-200'}`}
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className={`text-center p-6 rounded-xl ${theme === 'dark' ? 'bg-versiory-green/10 border border-versiory-green/30' : 'bg-green-50 border border-green-200'}`}>
            ...
            <div className={`text-center p-6 rounded-xl ${theme === 'dark' ? 'bg-versiory-azure/10 border border-versiory-azure/30' : 'bg-blue-50 border border-blue-200'}`}>
 ...
 <div className="mt-3">
            ...
            <div className={`text-center p-6 rounded-xl ${theme === 'dark' ? 'bg-versiory-pink/10 border border-versiory-pink/30' : 'bg-pink-50 border border-pink-200'}`}>
