            ...
            >
               {companyName.split('').map((letter, index) => (
                 <motion.span
                   ...
                   transition={{ 
                    ...
                    transition={{
                      ...
                      filter: { duration: 2, repeat: Infinity, delay: index * 0.1 }
                    }}
                 >
                   {letter}
                 </motion.span>
                ...
                <motion.span
                  ...
                  className="inline-block text-6xl md:text-8xl font-extrabold bg-gradient-to-r from-versory-green to-versory-azure bg-clip-text text-transparent ml-2"
                >
                  |
                </motion.span>
             </motion.h1>
