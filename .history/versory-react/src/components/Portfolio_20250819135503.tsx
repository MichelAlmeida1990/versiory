...
const Portfolio = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      image: "/images/fotografo-unsplash-hq.png?v=1",
      category: "professional",
                  ...
                  >
                    ...
                    <div className="relative group">
                      <motion.div
                        ...
                        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-versory-blue/10 to-versory-azure/10 backdrop-blur-sm border border-versory-azure/60 shadow-2xl h-full"
                        style={{
                      ...
                      >
                        ...
                        <div className="relative">
                          {project.mockup ? (
                            ...
                            <div className="aspect-[3/4] bg-gradient-to-br from-versory-black/50 to-versory-blue/20 flex items-center justify-center overflow-hidden rounded-xl">
                              <motion.div
