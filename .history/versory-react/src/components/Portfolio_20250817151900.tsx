                          ...
                          {project.mockup ? (
                            <div className="relative group">
                              <img 
                                ...
                                onLoad={() => console.log(`Mockup carregado: ${project.mockup}`)}
                                onError={(e) => console.error(`Erro ao carregar mockup: ${project.mockup}`, e)}
                              />
                              ...
                              <div className="absolute inset-0 flex items-center justify-center p-8">
                                ...
                                >
                                  <img 
                                    ...
                                    onError={(e) => console.error(`Erro ao carregar imagem: ${project.image}`, e)}
                                  />
                                </motion.div>
                              </div>
