      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-versiory-pink/20 to-versiory-green/20 backdrop-blur-sm border border-versiory-pink/30 rounded-full px-4 py-2 sm:px-6 sm:py-3 mb-4 sm:mb-6">
            ...
            <span className="text-versiory-pink font-semibold text-sm sm:text-base">Carrossel 3D</span>
          </div>
          
          <h2 className={`text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 sm:mb-6 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
            <span className="bg-gradient-to-r from-versiory-green via-versiory-azure to-versiory-pink bg-clip-text text-transparent">
              PROJETOS
            </span>
          </h2>
          
          <p className={`text-lg sm:text-xl max-w-3xl mx-auto px-4 ${theme === 'dark' ? 'text-white/80' : 'text-gray-700'}`}>
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-6 md:p-8 space-y-3 sm:space-y-4 md:space-y-6">
                      <div>
                        <h3 className={`text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                          {project.title}
                        </h3>
                        <motion.a
