    ...
    case 'rotate':
      return {
        ...
        transition: {
          ...
          scale: { duration: 2, repeat: Infinity, ease: [0.4, 0, 0.2, 1], delay: baseDelay }
        }
      };
    case 'pulse':
      return {
...
const TechStackVisor = () => {
  ...
  const techStack: TechIcon[] = useMemo(() => [
    ...
    { name: 'Next.js', icon: <FileCode size={32} />, color: theme === 'dark' ? '#FFFFFF' : '#000000', bgColor: theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)', animationType: 'pulse' },
