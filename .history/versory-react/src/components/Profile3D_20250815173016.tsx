...
const Profile3D = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-versory-blue/10 to-versory-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-versory-azure font-semibold">Nossa Equipe</span>
          </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="text-center space-y-4" style={{ transform: 'translateZ(30px)' }}>
                  <h3 className="text-2xl font-bold text-white">Versory Team</h3>
                  <p className="text-versory-green font-semibold">Desenvolvimento Full-Stack</p>
                  <p className="text-white/80 text-sm">
                    Especializados em React, Django, Firebase e desenvolvimento web moderno
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-versory-green/20 to-versory-azure/20 backdrop-blur-sm border border-versory-green/30 rounded-xl p-4 w-48">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3 text-white/90">
                      ...
                      <span className="text-sm">(11) 95854-0171</span>
                    </div>
                    <div className="flex items-center space-x-3 text-white/90">
