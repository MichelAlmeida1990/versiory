            ...
            return (
              ...
              >
                ...
                <div className="relative w-full h-full group">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent rounded-xl flex items-end p-4 transition-opacity duration-300 ${
