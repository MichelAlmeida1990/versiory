...
const About = () => {
  ...
  return (
    <section id="empresa" className="py-20 bg-gradient-to-b from-versory-black to-versory-blue/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <ScrollReveal direction="left" delay={0.1}>
              <motion.div
                ...
                className="bg-gradient-to-br from-versory-blue/20 to-versory-azure/20 backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-8"
              >
            ...
            <ScrollReveal direction="left" delay={0.2}>
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="bg-gradient-to-br from-versory-pink/20 to-versory-green/20 backdrop-blur-sm border border-versory-pink/30 rounded-2xl p-8"
              >
        ...
        <ScrollReveal direction="up" delay={0.4}>
          <div className="text-center mb-12">
            ...
            <p className="text-white/80">Os pilares que guiam nossa jornada de inovação</p>
          </div>
        </ScrollReveal>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {values.map((value, index) => (
            <ScrollReveal key={value.letter} direction="up" delay={0.1 * index}>
              <motion.div
                whileHover={{ 
                  scale: 1.05,
                  y: -10,
                ...
                className="bg-gradient-to-br from-versory-black/50 to-versory-blue/20 backdrop-blur-sm border border-versory-azure/20 rounded-xl p-6 hover:border-versory-green/50 transition-all duration-300"
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-white font-semibold">{value.title}</span>
                    </div>
