...
const techStack: TechIcon[] = [
  { name: 'React', icon: <React size={32} />, color: '#61DAFB', bgColor: 'rgba(97, 218, 251, 0.1)' },
  { name: 'Next.js', icon: <Code size={32} />, color: '#FFFFFF', bgColor: 'rgba(255, 255, 255, 0.1)' },
  { name: 'TypeScript', icon: <Code size={32} />, color: '#3178C6', bgColor: 'rgba(49, 120, 198, 0.1)' },
  ...
  { name: 'MongoDB', icon: <Database size={32} />, color: '#47A248', bgColor: 'rgba(71, 162, 72, 0.1)' },
  ...
  { name: 'Git', icon: <Code size={32} />, color: '#F05032', bgColor: 'rgba(240, 80, 50, 0.1)' },
