...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="py-20 bg-gradient-to-b from-versory-black to-versory-blue/10">
                ...
                index === currentProject && (
                  ...
                  >
                    ...
                    <div className="relative group">
                      ...
                      >
                        <div className="aspect-video bg-gradient-to-br from-versory-black/50 to-versory-blue/20 flex items-center justify-center">
                          <div className="text-center">
                            <div className="w-32 h-32 bg-gradient-to-br from-versory-azure to-versory-pink rounded-full mx-auto mb-4 flex items-center justify-center">
                              <span className="text-4xl font-bold text-white">
                                {project.title.charAt(0)}
                              </span>
                            </div>
                            <p className="text-white/80 text-sm">Preview do Projeto</p>
                          </div>
                        </div>
