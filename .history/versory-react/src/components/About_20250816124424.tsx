            ...
            <ScrollReveal direction="left" delay={0.1}>
              <motion.div
                whileHover={{ scale: 1.02 }}
                                 className={`backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-blue/20 to-versory-azure/20' : 'bg-transparent'}`}
              >
