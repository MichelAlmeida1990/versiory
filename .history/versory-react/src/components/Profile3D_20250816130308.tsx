          ...
          <ScrollReveal direction="left" className="space-y-8">
            <motion.div
              ...
              transition={{ delay: 0.3 }}
                                                           className={`backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-blue/10 to-versory-azure/10' : 'bg-blue-light'}`}
            >
