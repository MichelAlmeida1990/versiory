          ...
          <ScrollReveal direction="left" className="space-y-8">
            <motion.div
              ...
              transition={{ delay: 0.3 }}
                                                           className={`backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-blue/10 to-versory-azure/10' : 'bg-white/10 backdrop-blur-md'}`}
            >
          ...
          <ScrollReveal direction="right" className="space-y-8">
            ...
            <motion.div
              ...
              transition={{ delay: 0.4 }}
                                                           className={`backdrop-blur-sm border border-versory-green/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-green/10 to-versory-azure/10' : 'bg-white/10 backdrop-blur-md'}`}
            >
            ...
            <motion.div
              ...
              transition={{ delay: 0.5 }}
                                                           className={`backdrop-blur-sm border border-versory-pink/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-pink/10 to-versory-green/10' : 'bg-white/10 backdrop-blur-md'}`}
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className={`flex items-center space-x-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-versory-black/20' : 'bg-white/10 backdrop-blur-md'}`}>
