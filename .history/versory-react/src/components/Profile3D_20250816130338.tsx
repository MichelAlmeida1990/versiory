          ...
          <ScrollReveal direction="right" className="space-y-8">
            ...
            <motion.div
              ...
              transition={{ delay: 0.5 }}
                                                           className={`backdrop-blur-sm border border-versory-pink/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-pink/10 to-versory-green/10' : 'bg-blue-light'}`}
            >
