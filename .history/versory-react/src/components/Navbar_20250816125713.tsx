  ...
  return (
    <motion.nav
      ...
      animate={{ y: 0 }}
         ...
         isScrolled
           ? 'backdrop-blur-md border-b border-versory-azure/20'
           : 'bg-transparent'
       }`}
             style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
                                           className={`md:hidden overflow-hidden ${theme === 'dark' ? 'bg-versory-black/95' : 'bg-white/20 backdrop-blur-md'} backdrop-blur-md border-t border-versory-azure/20`}
        >
