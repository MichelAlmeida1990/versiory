...
const Contact = () => {
  ...
  return (
    <section id="contact" className={`py-20 ${theme === 'dark' ? 'bg-gradient-to-b from-versory-black to-versory-blue/10' : 'bg-gradient-to-b from-gray-50 to-blue-50/30'}`}>
          ...
          <ScrollReveal direction="left" className="space-y-8">
            <motion.div
              ...
              transition={{ delay: 0.3 }}
                             className={`backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-blue/10 to-versory-azure/10' : 'bg-white/10'}`}
            >
          ...
          <ScrollReveal direction="right" className="space-y-8">
            ...
            <motion.div
              ...
              transition={{ delay: 0.4 }}
                             className={`backdrop-blur-sm border border-versory-green/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-green/10 to-versory-azure/10' : 'bg-white/10'}`}
            >
            ...
            <motion.div
              ...
              transition={{ delay: 0.5 }}
                             className={`backdrop-blur-sm border border-versory-pink/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-pink/10 to-versory-green/10' : 'bg-white/10'}`}
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center space-x-3 p-3 bg-versory-black/20 rounded-lg">
                  ...
                  <span className="text-sm text-white/90">Microsoft Azure</span>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-versory-black/20 rounded-lg">
                  ...
                  <span className="text-sm text-white/90">AWS Cloud</span>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-versory-black/20 rounded-lg">
                  ...
                  <span className="text-sm text-white/90">Oracle Front-End</span>
                </div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-versory-black/20 rounded-lg">
                  ...
                  <span className="text-sm text-white/90">Java Programming</span>
                </div>
              </div>
            </motion.div>
          </ScrollReveal>
