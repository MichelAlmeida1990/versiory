        ...
        <ScrollReveal direction="up" delay={0.3}>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                {/* Card Principal */}
                                 <div className={`relative overflow-hidden rounded-2xl p-8 h-full transition-all duration-500 backdrop-blur-sm border group-hover:border-white/30 ${theme === 'dark' ? `${service.gradient} bg-opacity-20 border-white/10` : 'bg-transparent border-versory-azure/20'}`}>
