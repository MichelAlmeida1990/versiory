              ...
              <motion.div
                whileHover={{ 
                  ...
                  boxShadow: "0 20px 40px rgba(0, 0, 0, 0.3)"
                                 ...
                                 className={`backdrop-blur-sm border border-versory-azure/20 rounded-xl p-6 hover:border-versory-green/50 transition-all duration-300 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-black/50 to-versory-blue/20' : 'bg-transparent'}`}
              >
