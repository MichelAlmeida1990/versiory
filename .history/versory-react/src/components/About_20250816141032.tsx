        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div ref={ctaAnimation.ref} style={ctaAnimation.style} className="text-center">
            <motion.div
              ...
              className={`backdrop-blur-sm border border-versory-green/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-green/20 to-versory-azure/20' : 'bg-blue-light'}`}
            >
