...
const Contact = () => {
  ...
  return (
    <section id="contact" className={`py-20 ${theme === 'dark' ? 'bg-gradient-to-b from-versiory-black to-versiory-blue/10' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={headerAnimation.ref} style={headerAnimation.style} className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-versiory-green/20 to-versiory-azure/20 backdrop-blur-sm border border-versiory-green/30 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-versiory-azure font-semibold">Entre em Contato</span>
          </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center space-x-4 ${theme === 'dark' ? 'text-white/90' : 'text-gray-800'}`}>
                  ...
                  <div>
                    <p className="text-sm text-versiory-azure/80">WhatsApp Principal</p>
                ...
                <div className={`flex items-center space-x-4 ${theme === 'dark' ? 'text-white/90' : 'text-gray-800'}`}>
                  ...
                  <div>
                    <p className="text-sm text-versiory-azure/80">WhatsApp Secundário</p>
                ...
                <div className={`flex items-center space-x-4 ${theme === 'dark' ? 'text-white/90' : 'text-gray-800'}`}>
                  ...
                  <div>
                    <p className="text-sm text-versiory-azure/80">Localização</p>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-versiory-azure/80">Satisfação</p>
                    </div>
                  </div>
                </motion.div>
              </div>
              ...
              <div ref={certificationsAnimation.ref} style={certificationsAnimation.style}>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                                         <div className={`flex items-center space-x-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-versiory-black/10' : 'bg-blue-light/70'}`}>
                       <div className="w-8 h-8 bg-gradient-to-br from-versiory-blue/20 to-versiory-azure/20 rounded flex items-center justify-center">
                         <span className="text-xs font-bold text-versiory-azure">MS</span>
                       </div>
                       ...
                       <div className="w-8 h-8 bg-gradient-to-br from-versiory-orange/20 to-versiory-yellow/20 rounded flex items-center justify-center">
                         <span className="text-xs font-bold text-versiory-orange">AWS</span>
                       </div>
                       ...
                       <div className="w-8 h-8 bg-gradient-to-br from-versiory-red/20 to-versiory-pink/20 rounded flex items-center justify-center">
                         <span className="text-xs font-bold text-versiory-red">OR</span>
                       </div>
                       ...
                       <div className="w-8 h-8 bg-gradient-to-br from-versiory-green/20 to-versiory-blue/20 rounded flex items-center justify-center">
                         <span className="text-xs font-bold text-versiory-green">J</span>
                       </div>
