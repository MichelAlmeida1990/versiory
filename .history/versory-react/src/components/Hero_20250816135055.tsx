...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ backgroundColor: 'var(--background)' }}>
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-8 py-20 max-w-4xl mx-auto mt-20 backdrop-blur-sm bg-white/10 border border-white/20 rounded-3xl">
          <motion.div
          ...
          >
                                     <motion.p
              className={`text-xl md:text-2xl mb-12 max-w-3xl mx-auto font-light ${theme === 'dark' ? 'text-white/90' : 'text-white/90'}`}
            >
              {description}
            </motion.p>
          </motion.div>
