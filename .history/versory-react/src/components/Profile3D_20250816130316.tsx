          ...
          <ScrollReveal direction="right" className="space-y-8">
            ...
            <motion.div
              ...
              transition={{ delay: 0.4 }}
                                                           className={`backdrop-blur-sm border border-versory-green/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-green/10 to-versory-azure/10' : 'bg-blue-light'}`}
            >
