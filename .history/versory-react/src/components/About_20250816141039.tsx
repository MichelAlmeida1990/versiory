            ...
            {values.map((value, index) => (
              <div key={value.letter} ref={valuesStagger.refs[index]} style={valuesStagger.getStaggerStyle(index)}>
                <motion.div
                  ...
                  className={`backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-6 h-full ${theme === 'dark' ? 'bg-gradient-to-br from-versory-blue/10 to-versory-azure/10' : 'bg-blue-light'}`}
                >
