              ...
              <motion.button
                ...
                className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 ${
                  filter === category.key
                     ...
                     : `${theme === 'dark' ? 'bg-versory-black/50' : 'bg-white/10'} ${theme === 'dark' ? 'text-white' : 'text-gray-800'} border border-versory-azure/30 hover:border-versory-green/50`
                }`}
              >
                {category.label}
              </motion.button>
          ...
          <div className="relative">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.map((tech) => (
                                                         <span
                               key={tech}
                               className={`px-3 py-1 border border-versory-azure/30 rounded-full text-sm ${theme === 'dark' ? 'bg-versory-black/50 text-white/80' : 'bg-gray-100 text-gray-700'}`}
                             >
                              {tech}
                            </span>
                          ))}
            ...
            <div className="flex justify-center mt-12 space-x-4">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className={`w-12 h-12 border border-versory-azure/30 rounded-full flex items-center justify-center text-versory-azure hover:border-versory-green/50 transition-all duration-300 ${theme === 'dark' ? 'bg-versory-black/50' : 'bg-white/50'}`}
              >
