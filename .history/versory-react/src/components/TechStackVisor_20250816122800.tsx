        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                   ...
                   whileTap={{ scale: 0.9 }}
                   className={`w-10 h-10 border border-versory-azure/30 rounded-full flex items-center justify-center text-versory-azure hover:bg-versory-azure hover:text-black transition-all duration-300 ${theme === 'dark' ? 'bg-versory-black/50' : 'bg-white/50'}`}
                 >
                  <X size={20} />
                </motion.button>
              </div>
              ...
              {/* Visor Container */}
                             <div className={`relative overflow-hidden border border-versory-azure/20 rounded-xl p-6 ${theme === 'dark' ? 'bg-versory-black/50' : 'bg-gray-100/50'}`}>
                {/* Marquee Container */}
