        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="space-y-8">
            ...
            <ScrollReveal direction="left" delay={0.2}>
              <motion.div
                whileHover={{ scale: 1.02 }}
                                 className={`backdrop-blur-sm border border-versory-pink/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-pink/20 to-versory-green/20' : 'bg-transparent'}`}
              >
