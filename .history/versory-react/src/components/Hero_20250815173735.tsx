...
import { ChevronDown, Sparkles, Zap, Star, Smartphone, Code, Palette } from 'lucide-react';
import ScrollReveal from './ScrollReveal';

const Hero = () => {
  // Função para obter dimensões da janela de forma segura
  const getWindowDimensions = () => {
    ...
    return { width: 1200, height: 800 }; // Valores padrão para SSR
  };
