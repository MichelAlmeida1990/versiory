...
const Hero = () => {
  ...
  return (
    <section id="home" className={`relative min-h-screen flex items-center justify-center overflow-hidden ${theme === 'dark' ? 'bg-versory-black' : 'bg-white'}`}>
      ...
      <div className="absolute inset-0">
        ...
        {/* Overlay Gradient */}
        <div className={`absolute inset-0 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-black/70 via-versory-black/50 to-versory-black/30' : 'bg-gradient-to-br from-white/70 via-white/50 to-white/30'}`} />
      </div>
