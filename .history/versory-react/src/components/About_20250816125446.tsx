        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="space-y-8">
            <ScrollReveal direction="left" delay={0.1}>
              <motion.div
                whileHover={{ scale: 1.02 }}
                                                                   className={`backdrop-blur-sm border border-versory-azure/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-blue/20 to-versory-azure/20' : 'bg-white/10 backdrop-blur-md'}`}
              >
            ...
            <ScrollReveal direction="left" delay={0.2}>
              <motion.div
                whileHover={{ scale: 1.02 }}
                                                                   className={`backdrop-blur-sm border border-versory-pink/30 rounded-2xl p-8 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-pink/20 to-versory-green/20' : 'bg-white/10 backdrop-blur-md'}`}
              >
              ...
              <motion.div
                whileHover={{ 
                  ...
                  boxShadow: "0 20px 40px rgba(0, 0, 0, 0.3)"
                                                                   ...
                                                                   className={`backdrop-blur-sm border border-versory-azure/20 rounded-xl p-6 hover:border-versory-green/50 transition-all duration-300 ${theme === 'dark' ? 'bg-gradient-to-br from-versory-black/50 to-versory-blue/20' : 'bg-white/10 backdrop-blur-md'}`}
              >
