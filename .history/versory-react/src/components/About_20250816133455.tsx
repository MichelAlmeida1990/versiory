  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          {/* CTA Button */}
          <div ref={ctaAnimation.ref} style={ctaAnimation.style} className="text-center lg:text-left">
            <motion.button
              whileHover={{ 
                scale: 1.05, 
        ...
        <div ref={valuesAnimation.ref} style={valuesAnimation.style}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((value, index) => (
              <div key={`value-${index}-${value.letter}`} ref={valuesStagger.refs[index]} style={valuesStagger.getStaggerStyle(index)}>
                <motion.div
                  whileHover={{ 
                    scale: 1.05,
                    y: -10,
