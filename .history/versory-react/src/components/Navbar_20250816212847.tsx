...
const Navbar = () => {
  ...
  return (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
             className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-xl border-b border-versory-azure/30 transition-all duration-300 shadow-2xl`}
       style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            />
            <motion.span 
              className="text-3xl font-bold bg-gradient-to-r from-versory-green to-versory-azure bg-clip-text text-transparent"
              animate={{
                opacity: [1, 0.3, 1],
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
                                           className={`md:hidden overflow-hidden ${theme === 'dark' ? 'bg-versory-black/95' : 'bg-blue-light'} backdrop-blur-md border-t border-versory-azure/20`}
        >
